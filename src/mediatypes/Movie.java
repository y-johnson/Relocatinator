...
public class Movie extends Media {
     ...
     */
    public Movie (String path, MediaTypes mediatype) {
...
//
//        super(pathname, MediaTypes.MOVIE);
...
//        metadata [7] = MetadataOps.getResolution(filename.replace(Handbrake.sourceFolder,""));
//
